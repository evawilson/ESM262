...
```
**Figure 1.** The relationship between soil moisture availability (mm) and irrigation amount (mm) for three crops: barley, corn and wheat. Soil moisture availability was calculated using precipitation and evapotranspiration rates. Here, we see that wheat is the most water intensive crop of the three.
