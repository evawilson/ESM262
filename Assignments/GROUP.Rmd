...
a. Input: Snow pack and soil moisture 
...
Added together, these parameters generate a single raster output:
(a + b + c + d + e = f (final output))

*Figure 1.* [pull from Sarah] 